// videoson-codec-av1/src/backend/mod.rs
...
#[cfg(all(feature = "backend-dav1d", not(any(target_arch = "wasm32", target_os = "android"))))]
mod dav1d_backend;
#[cfg(all(feature = "backend-dav1d", not(any(target_arch = "wasm32", target_os = "android"))))]
pub use dav1d_backend::Av1Decoder;

#[cfg(all(feature = "backend-dav1d", any(target_arch = "wasm32", target_os = "android")))]
...
compile_error!("Enable an AV1 backend feature: backend-rav1d (pure Rust) or backend-dav1d (temporary).");